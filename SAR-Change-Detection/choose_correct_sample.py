...
def main():
    # 原始路径
    pic_time1 = '.\\dataset\\FarmlandD\\200806.bmp'
    pic_time2 = '.\\dataset\\FarmlandD\\200906.bmp'
    pseudo_label = '.\\step1_Pseudo_label\\FarmlandD_pseudp_label.png'

    # 目标路径
    dst_image_path = '.\\step2_dataset_dst\\FarmlandD_final\\image\\'
    dst_label_path = '.\\step2_dataset_dst\\FarmlandD_final\\label\\'
