...
test_img_path = 'step3_test_dataset\FarmlandD_test'
model = 'model\checkpoints\checkpoints_DCP9_val_0.005113.pth'
use_gpu = 1
...
for sub in all_sub_list:
    ...
    num += 1
    cv2.imwrite('step3_test_dataset/FarmlandD_result10.png', result)
    print(num)
