...
def train_net(net,
              ...
              save_cp=True,
              gpu=True):
    train_img_dir = './step2_dataset_dst/FarmlandD_final//train/image/'
    train_msk_dir = './step2_dataset_dst/FarmlandD_final//train/label/'
    val_img_dir = './step2_dataset_dst/FarmlandD_final//val/image/'
    val_msk_dir = './step2_dataset_dst/FarmlandD_final//val/label/'
    dir_checkpoint = './model/checkpoints/checkpoints_D'
